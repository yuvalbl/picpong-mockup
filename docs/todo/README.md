...
- [ ] [palette-refinement.md](palette-refinement.md) - warm up the home page: KEEP the hero pond (the fish's water, bookended with the sustainability ocean), warm funnel lane 02, cut coral, one-accent-per-section (color *cohesion*, not the contrast fix already in the a11y/font todos)
